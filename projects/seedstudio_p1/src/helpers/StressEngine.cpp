...
void StressEngine::updateFromDispatcher(uint32_t n_tx_packets, uint32_t n_rx_packets, uint32_t n_dc_delays, uint32_t n_lbt_delays, uint32_t n_recv_errors, uint32_t n_ghost_packets) {
  ...
  _window.ghost_packets = n_ghost_packets;  // Store ghost packet count
